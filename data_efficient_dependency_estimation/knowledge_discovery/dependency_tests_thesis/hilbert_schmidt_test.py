...
class HilbertSchmidtIndependenceTest(RKnowledgeDiscoveryTask):

    def __init__(self) -> None:
        self.packageName = ('dHSIC')
        super().__init__()
        self.test = self.package.dHSIC
    ...
    def learn(self, num_queries):
        ...
        r, p = self.test(xs, ys,kernel=("gaussian","discrete"))
