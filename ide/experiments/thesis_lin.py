...
from ide.building_blocks.multi_sample_test import FIT, KWHMultiSampleTest, Kendalltau, Pearson, Spearmanr, XiCor
...
blueprint = Blueprint(
    ...
    evaluators=[PlotNewDataPointsEvaluator(), BoxPlotTestPEvaluator(folder="fig_de")],
