...
from ide.modules.oracle.data_source import CrossDataSource, HourglassDataSource, IndependentDataSetDataSource, LineDataSource
...
synthetic_data_sources.append(IndependentDataSetDataSource()),
