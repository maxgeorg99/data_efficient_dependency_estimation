...
from ide.building_blocks.multi_sample_test import CMI, MCDE, HiCS, KWHMultiSampleTest
...
blueprint1 = Blueprint(
    ...
    oracle = Oracle(
        data_source=LineDataSource((1,),(2,)),
    ...
    experiment_modules=DependencyExperiment(
        dependency_test=DependencyTest(
            ...
            multi_sample_test = HiCS()
            ),
        ),
    evaluators=[DataEfficiencyEvaluator(),LogBluePrint(),LogNewDataPointsEvaluator()],
)
